...
<link rel="stylesheet" href="css/style.css" />
 ...
 <body>
	<div id="wrap">
		<form id="join">
		<fieldset>
		<legend>회원 수정 정보 입력</legend>
			<ul>
				<li><label class="label">아이디　</label><input type="text" id="user_id" required autofocus  readonly></li>
				...
				<li><label class="label">이름　</label><input type="text" id="user_name" required  readonly></li>
				...
				<li><label class="label">우편번호　</label> <input type="text" id="user_post_code" size="10"> <input type="button" value="찾기" class="btn"></li>
				...
				<li><div class="center"><input type="submit" value="정보수정" class="btn"> <input type="reset" value="다시입력" class="btn"></div></li>
			</ul>
			</fieldset>
		</form>
	</div><!--wrap 닫는태그-->
